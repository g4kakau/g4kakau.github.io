...
| $0.2$ | $1.5869$ | $1.5865$ | $1.5869$ |
| $0.5$ | $1.6858$ | $1.6690$ | $1.6828$ |
| $0.7$ | $1.8457$ | $1.7632$ | $1.8163$ |
| $0.9$ | $2.2805$ | $1.8889$ | $2.0338$ |
| $0.99$ | $3.3566$ | $1.9557$ | $2.1679$ |

**表 1：** $K(k)$ 精確值與冪級數截斷值的比較。由於級數每一項都是正的，任何截斷都必然**低估**真值；$k$ 越靠近 $1$，低估得越嚴重、需要的項數越多。
{: .fig-caption }
