...
$$2 \times 1.3506 \times 1.8541 - 1.8541^2 \approx 5.011 - 3.438 \approx 1.573 \approx \frac{\pi}{2} \checkmark$$

這個關係式在數值計算和理論分析中都很有用，也是橢圓積分滿足的「微分方程」（Picard–Fuchs 方程）的積分形式。
