...
要避開奇點，連間隔也要挑過。例如 $\tan10^\circ+\tan20^\circ+\cdots+\tan170^\circ$ **仍然不能用**——因為 $90^\circ$ 剛好是 $10^\circ$ 的倍數，$\tan90^\circ$ 又混進來了。改成間隔 $20^\circ$ 就安全了：
...
把 $\tan20^\circ$ 與 $\tan160^\circ$、$\tan40^\circ$ 與 $\tan140^\circ$……兩兩配對成 0，總和為 0——但配對的規則和 $\sin,\cos$ 不同，要特別小心。
...
9. $\tan20^\circ+\tan40^\circ+\cdots+\tan160^\circ$（再想想：若改成間隔 $10^\circ$ 會發生什麼事？）
...
2. $0$
3. $0$
4. $\dfrac{89}{2}$（$44$ 對各得 $1$，再加中間的 $\sin^2 45^\circ=\tfrac12$）
5. $4$
6. $\dfrac{45}{2}$
7. $1$
8. $1$
9. $0$（若改成間隔 $10^\circ$ 就會含 $\tan90^\circ$，變成無意義）
